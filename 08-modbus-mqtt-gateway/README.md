...
![MQTT JSON](demo/modbus_macbook_json.png)

### Side by side — MQTT subscriber and Modbus master
![Side by side](demo/modbus_side_by_side.png)

### Modbus master formatted output
![Master output](demo/modbus_master_output.png)

### Modbus slave generating sensor data
![Slave output](demo/modbus_slave_output.png)

### Gateway running with slave and master together
![Gateway](demo/modbus_gateway_running.png)
...
The only difference between this project and production:
